...
from utils.diff_utils import visualize_samples
...
if __name__ == '__main__':
    ...
    # noise2noise, params = train_diffusion(dataloader, training_parameters, diffusion_parameters, model_parameters)
    # print('Before model training...')


    # This is for testing
    # -----
    noise2noise = UNet(dim=args.image_size, channels=args.channels, dim_mults=(1, 2, 4), use_convnext=False)
    ...
    if args.keep_model: deposit_model(noise2noise, experiment_name)
    ...
    # denoising from samples using sample_idx
